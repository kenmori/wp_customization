...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by moritakenji on 2016/11/27.
	 */
	...
	(function (e, t) {
	  var n,
	    ...
	    return this.length;
	  }, x.fn.andSelf = x.fn.addBack, "object" == ( false ? "undefined" : _typeof(module)) && module && "object" == _typeof(module.exports) ? module.exports = x : (e.jQuery = e.$ = x, "function" == "function" && __webpack_require__(3) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return x;
...
/***/ function(module, exports) {
	...
	*/
	 ...
	 * @const {string}
	 */
	googlePublisherPluginPreviewLoader.FRONTEND_URL = 'https://publisherplugin.google.com';
	...
	googlePublisherPluginPreviewLoader.receiveMessage = function (event) {
	  ...
	  if (data.action == 'load_script' && data.relativeScriptSrc.indexOf('/_/publisher_plugin/') == 0 && !googlePublisherPluginPreviewLoader.previewInjectorScriptLoaded) {
	    var script = document.createElement('script');
	    script.type = 'text/javascript';
	    script.src = 'https://www.gstatic.com' + data.relativeScriptSrc;
	...
	window.addEventListener('message', googlePublisherPluginPreviewLoader.receiveMessage, false);

	window.addEventListener('DOMContentLoaded', googlePublisherPluginPreviewLoader.getScripts, false);
